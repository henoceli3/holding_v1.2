...
import com.holding.models.Appartement;
import com.holding.models.Contrat;
    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                settings.put(Environment.URL, "jdbc:mysql://localhost:3306/holding_bd?useSSL=false");
                ...
                configuration.addAnnotatedClass(Locataire.class);
